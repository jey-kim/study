...
cp latlong_gps.dat latlong_FT_InSAR.dat
...
cp latlong_FT_InSAR.dat output.dat
...
cp vel.gmt vel_hori_FT_"$i"_"$j"_on_InSAR.gmt
awk '{print $1-360,$2,$3,$4,$5,$6,$7}' vel.gmt > vel_hori.gmt

cp latlong_FT_InSAR.dat nout.dat
...
cp vel_vert.gmt vel_vert_FT_"$i"_"$j"_on_InSAR.gmt
...
cp basis_function_FT_hori_"$i"_"$j".ps plots_FT_on_InSAR
...
./image_basis_function_FT_vert_smaller_circle
cp basis_function_FT_vert.ps basis_function_FT_vert_"$i"_"$j".ps
cp basis_function_FT_vert_"$i"_"$j".ps plots_FT_on_InSAR
